...
from .views import Home, AboutView, CatalogueListView, SolutionView, SolutionDetail, ContactFormView, PartenaireView, GammeDetailList, BlogView, PostDetail
urlpatterns = [
    ...
    path('produits-<slug:slug>/', GammeDetailList.as_view(), name= 'gamme'),
